--[[
	Tutorial On How To Run On AntiBoomzer SB Or OxCool Sb..
	
	Step 1 : Get The Script (This Script)
	
	Step 2 : Make A Pastebin Account Or Stypi Account
	
	Step 3 : Upload The Script (Unlisted If You Want!!) (Paste It)
	
	Step 4 : Go To The Sb..
	
	Step 5 : Put /e hl/Link Of Your Pastebin / Stypi Here!!
	
	Example : pastebin.c0m/raw?i=Link Of PasteBin Here (Must Include (raw?i=) !!!
--]]

--[[ Tigre Blood Script Leaked ]]--
   --[[ I Got This From A Friend!! ]]--
   --[[ Hope You Enjoy ]]--

--[[ Leakers Inc V2.0 Has Striked ]]--
